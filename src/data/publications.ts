...
export const publications: Publication[] = [
  {
    ...
    highlight:
      "Co-authored published study using nonuniform discrete Fourier transform (NUDFT) to analyze multi-year wind records from six U.S. airports, revealing scale- and distance-dependent coherence across the national airspace system.",
    myRole:
